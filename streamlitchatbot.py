...
if "current_page" not in st.session_state:
    st.session_state.current_page = "Normal Chat"
...
# Navigation Buttons
if st.session_state.current_page == "Normal Chat":
    st.title("Normal Chat Page")
    st.write("You're in the Normal Chat interface. Switch to OpenAI Chat if you'd like!")
    ...
    # Button to switch to OpenAI Chat
    if st.button("Switch to OpenAI Chat"):
        st.session_state.current_page = "OpenAI Chat"

elif st.session_state.current_page == "OpenAI Chat":
    st.title("OpenAI Chat Page")
    st.write("You're in the OpenAI Chat interface. Switch to Normal Chat if you'd like!")
    
    user_input = st.chat_input("Ask OpenAI something...")
    if user_input:
        st.write(f"👨‍💻 : {user_input}")
        openai_response = query_openai(user_input)
        st.write(f"🤖 : {openai_response}")
    
    if st.button("Switch to Normal Chat"):
        st.session_state.current_page = "Normal Chat"
